...
export default function DashboardPage() {
  ...
  const totalBalance = groups.reduce((sum, group) => sum + group.user_balance, 0);
                        ...
                        >
                          <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                              {group.member_count} members • {formatCurrency(group.total_balance)} total
                            </p>
                          </div>
                          <div className="text-right">
                            <p className="font-medium">{formatCurrency(group.user_balance)}</p>
                        ...
                        >
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                {transaction.group_name} • {formatDate(transaction.created_at)}
                              </p>
                            </div>
                          </div>
